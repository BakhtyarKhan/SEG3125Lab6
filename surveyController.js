...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var stats = readData("stats");
        var favouriteTab = readData("favouriteTab");
        var statSelected = readData("statSelected");
        var comment = readData("comment");
        var rating = readData("rating");
        
        res.render('showResults', {results: [name, email, age, stats, favouriteTab, statSelected, comment, rating]});
        // console.log([name, email, age, stats, favouriteTab, statSelected, comment, rating]);
    });
    ...
    app.post('/index', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "statSelected") && (json[key].length >= 2) && (json[key] != "Player Goals") && (json[key] != "Player Assists") && (json[key] != "Player Passes") && (json[key] != "Player Cleansheets") && (json[key] != "Club Goals") && (json[key] != "Club Passes") && (json[key] != "Club Cleansheets") && (json[key] != "Club Crosses")){
